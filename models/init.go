...
func InitDB(dsn string) {
	...
	err = engine.Sync2(new(AdminUser), new(Tunnel), new(Certificate), new(TunnelClient), new(DnsProxy), new(TcpProxy), new(Rule), new(HttpProxy), new(ClusterNode), new(AcmeAccount))
