  ...
  >
        ...
        <re-col :value="24" :xs="24">
          ...
          >
            <el-input
              ...
              :placeholder="
                t(
                  'identity.sourceNamePlaceholder',
                  '如：本地账号认证、校园 CAS、企业 RADIUS'
                )
              "
              clearable
            />
    ...
    >
      ...
      <el-row :gutter="16">
        <re-col :value="16" :xs="24">
          <el-form-item :label="t('identity.casBaseUrl', 'CAS 服务基地址')">
            <el-input
              ...
              :placeholder="
                t(
                  'identity.casBaseUrlPlaceholder',
                  '如 https://sso.example.com/cas'
                )
              "
              clearable
            />
        ...
        <re-col :value="12" :xs="24">
          <el-form-item
            :label="t('identity.casValidatePath', 'Ticket 校验路径')"
          >
            <el-input
              v-model="casConfig.validate_path"
        ...
        <re-col :value="24" :xs="24">
          <el-form-item :label="t('identity.casSkipTls', '跳过 TLS 证书验证')">
            ...
            <span class="text-xs text-(--el-text-color-secondary) ml-2">
              {{
                t(
                  "identity.casSkipTlsTip",
                  "仅用于自签名或测试环境证书，生产环境建议关闭"
                )
              }}
            </span>
          </el-form-item>
    ...
    >
      ...
      <el-row :gutter="16">
        <re-col :value="16" :xs="24">
          <el-form-item :label="t('identity.radiusHost', '服务器地址 (Host)')">
            <el-input
              ...
              :placeholder="
                t(
                  'identity.radiusHostPlaceholder',
                  '如 192.168.1.100 或 radius.company.local'
                )
              "
              clearable
            />
        ...
        <re-col :value="12" :xs="24">
          <el-form-item
            :label="t('identity.radiusSecret', '共享密钥 (Secret)')"
          >
            <el-input
              ...
              show-password
              :placeholder="
                t('identity.radiusSecretPlaceholder', '请输入 RADIUS 共享密钥')
              "
            />
          </el-form-item>
        </re-col>
        ...
        <re-col :value="12" :xs="24">
          <el-form-item :label="t('identity.radiusProtocol', '认证协议')">
            <el-select v-model="radiusConfig.auth_protocol" class="w-full">
              <el-option
                label="PAP (Password Authentication Protocol)"
                value="PAP"
              />
        ...
        <re-col :value="24" :xs="24">
          <el-form-item :label="t('identity.radiusNasIp', 'NAS-IP 地址')">
            <el-input
              ...
              :placeholder="
                t('identity.radiusNasIpPlaceholder', '选填，如 10.0.0.1')
              "
              clearable
            />
          </el-form-item>
